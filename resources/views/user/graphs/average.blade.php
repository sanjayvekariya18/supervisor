    ...
    <div class="page-header card m-t-40">
        <div class="card-block caption-breadcrumb">
            <div class="breadcrumb-header">
                ...
                <hr>
            {{ Form::model($search,array('route' => 'graphs.average','id'=>'submit_report')) }}
            <?php
                $types['machines'] = 'Machines';
                ($p->worker_account) ? $types['workers'] = 'Workers' : '';
            ?>
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    {{ Form::button('Export',['type'=>'submit','data-target'=>'_blank','target'=>'_blank','formaction'=>route('graphs.average.export'),'class'=>'btn hor-grd btn-grd-warning btn-round search_report']) }}
                    <a href="{{ route('graphs.average',['reset'=>1]) }}" class="btn hor-grd btn-grd-inverse btn-round hover-white">Reset</a>
                </div>
            </div>
            {{ Form::close() }}
        </div>
