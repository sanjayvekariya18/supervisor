    ...
    <div class="page-header card m-t-40">
        <div class="card-block caption-breadcrumb">
            <div class="breadcrumb-header">
                <h5 class="m-b-5">
                    Permission For : <b class="text-danger">{{ $user->first_name }}</b>
                </h5>
            </div>
            <div class="page-header-breadcrumb">
                <a href="{{ url('/supervisors/list/') }}" class="text-danger"><strong>Back to List</strong></a>
            </div>
        </div>
    </div>
    <!-- Page header end -->
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="bs-example grid-layout">
                            {{ Form::model($permission,array('url' => ['/supervisors/permission/update',$user->id],'id'=>'frm_customer')) }}
                            <div class="row">
                                <div class="width-100">
                                    <div class="row">
                                        @foreach($permission as $key => $value)
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::checkbox($key,1,$value,['class'=>'js-primary'])}}
                                                </div>
                                            </div>    
                                        @endforeach
                                        {{-- <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ url('supervisors/list') }}" class="btn hor-grd btn-grd-inverse btn-round hover-white">Back</a>
