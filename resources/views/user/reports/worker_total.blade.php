...
@section('page_title','Worker Total')
@section('content')
    ...
    <div class="page-header card m-t-40">
        <div class="card-block caption-breadcrumb">
            <div class="breadcrumb-header">
                <h5 class="m-b-5">Worker Total</h5>
            </div>
                <hr>
            {{ Form::model($search,array('route' => 'reports.worker.total','id'=>'submit_report')) }}
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    {{ Form::button('Export',['type'=>'submit','data-target'=>'_blank','target'=>'_blank','formaction'=>route('reports.worker.total.export'),'class'=>'btn hor-grd btn-grd-warning btn-round search_report']) }}
                    <a href="{{ route('reports.worker.total',['reset'=>1]) }}" class="btn hor-grd btn-grd-inverse btn-round hover-white">Reset</a>
                </div>
            </div>
            {{ Form::close() }}
        </div>
