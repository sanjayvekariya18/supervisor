                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{Form::text('worker_id',null,['class'=>'form-control form-control-uppercase',$disabled])}}
                                        ...
                                        <div class="border-checkbox-section">
                                            ...
                                            @forelse ($machines_list as $key => $machine_details)
                                                ...
                                                <div class="border-checkbox-group border-checkbox-group-{{$checked_cls}} col-md-2">
                                                    ...
                                                    <label class="border-checkbox-label" for="machine_{{ $machine_details['id'] }}">{{ $machine_details['machine_name'] }}</label>
                                                </div>
                                            @empty
