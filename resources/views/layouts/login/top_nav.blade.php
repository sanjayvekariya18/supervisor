            ...
            <ul class="nav-right">
                <li class="header-notification">
                    ...
                    <ul class="show-notification">
                        ...
                        <li>
                            <div class="media">
                                {{ HTML::image('images/avatar-4.jpg', 'alt text', array('class' => 'd-flex align-self-center img-radius','alt'=>'Generic placeholder image')) }}
                                <div class="media-body">
                        ...
                        <li>
                            <div class="media">
                                {{ HTML::image('images/avatar-3.jpg', 'alt text', array('class' => 'd-flex align-self-center img-radius','alt'=>'Generic placeholder image')) }}
                                <div class="media-body">
